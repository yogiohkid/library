...
public class ColorArcProgressBar extends View
{
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        int color3 = a.getColor(R.styleable.ColorArcProgressBar_front_color3, color2);
        int color4 = a.getColor(R.styleable.ColorArcProgressBar_front_color4,color3);
        colors = new int[]{color1, color2, color3, color4,color4};
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //整个弧
        canvas.drawArc(bgRect, startAngle, sweepAngle, false, progressPaint);// TODO: 2016/7/21  allArcPaint修改为progressPaint




        //当前进度
        canvas.drawArc(bgRect, startAngle, currentAngle, false, allArcPaint);// TODO: 2016/7/21  progressPaint修改为allArcPaint
