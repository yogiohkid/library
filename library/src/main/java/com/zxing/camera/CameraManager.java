...
import com.joker.jokerlibrary.BaseApplication;
...
public final class CameraManager
{
    ...
    private static int MAX_FRAME_WIDTH = 1080;
    private static int MAX_FRAME_HEIGHT = 1080;
...
//      }
    ...
    public Rect getFramingRect()
    {
        ...
        if (framingRect == null)
        {
            ...
            int topOffset = DensityUtil.dip2px(BaseApplication.getContext(), 158);
