...
final class DecodeHandler extends Handler
{
    ...
    private void decode(byte[] data, int width, int height)
    {
        ...
        if (rawResult != null)
        {
            ...
            Message message = Message.obtain(activity.getHandler(), DecodeIds.DECODE_SUCCEED, rawResult);
        ...
        {
            Message message = Message.obtain(activity.getHandler(),DecodeIds.DECODE_FAILED);
            message.sendToTarget();
        }
    }
